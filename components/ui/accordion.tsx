...
function AccordionItem({
	...
	return (
		<AccordionPrimitive.Item
			...
			className={cn(
				"hover:bg-[#F7F7F7] dark:bg-muted dark:hover:bg-muted/70 transition-all px-6 py-4 rounded-lg shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]",
				className
			)}
			{...props}
		/>
